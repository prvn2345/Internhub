/**
 * ForgotPasswordPage
 * Allows users to reset their password using email OR phone number.
 * Rate-limited to once per day — shows a clear warning if already used.
 */
      ...
      <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md text-center">
          ...
          <p className="text-gray-400 dark:text-gray-500 text-sm mb-8">
            Check your inbox and use the new password to sign in.
            We recommend changing it immediately after login.
          </p>
      ...
      <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="card p-8 text-center">
            ...
            {/* The exact warning message from the spec */}
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2 text-sm leading-relaxed">
            ...
            password and send it to your email address.
          </p>
        </div>
        ...
        <div className="card p-8">
          ...
          <div className="flex items-start gap-2.5 bg-blue-50 dark:bg-blue-900/20
                          ...
                          px-3 py-2.5 mb-5">
            <ExclamationTriangleIcon className="w-4 h-4 text-blue-500 flex-shrink-0 mt-0.5" />
            <p className="text-blue-700 dark:text-blue-300 text-xs leading-relaxed">
              A new auto-generated password (letters only) will be emailed to your
              registered address. This option is available <strong>once per day</strong>.
            </p>
          </div>
