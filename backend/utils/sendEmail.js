...
const sendPasswordResetEmail = async (recipient, newPassword) => {
  // If newPassword is null, user set their own — send confirmation only
  const isAutoGenerated = newPassword !== null;
    ...
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;">
      ...
      <div style="background:#fafafa;padding:30px;border-radius:0 0 12px 12px;border:1px solid #e5e7eb;">
        <h2 style="color:#111827;margin-top:0;">
          ${isAutoGenerated ? 'Your New Auto-Generated Password' : 'Password Changed Successfully'}
        </h2>
        ${isAutoGenerated ? `
        ...
        <p style="color:#9ca3af;font-size:13px;">
          🔒 This password contains only letters for easy reading and typing.
        </p>
        ` : `
        <p style="color:#6b7280;font-size:15px;line-height:1.6;">
          Your password has been updated successfully with the password you chose.
  ...
  await dispatchEmail(
    recipient,
    isAutoGenerated ? 'Your New Password — CareerBridge' : 'Password Changed — CareerBridge',
    html
  );
};
